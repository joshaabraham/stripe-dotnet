namespace Stripe
{
    ...
    /// payment instrument and can be used with the Source API just like a card object: once
    /// chargeable, they can be charged, or attached to customers.
    /// </summary>
    public class Source : StripeEntity<Source>, IHasId, IHasMetadata, IHasObject, IPaymentSource
    {
        ...
        /// <summary>
        /// Amount associated with the source. This is the amount for which the source will be
        /// chargeable once ready. Required for single-use sources.
        /// </summary>
        [JsonProperty("amount")]
        ...
        /// <summary>
        /// The currency associated with the source. This is the currency for which the source will
        ...
        /// <summary>
        /// Information related to the receiver flow. Present if the source is a receiver (flow is
        /// receiver).
        /// </summary>
        ...
        /// <summary>
        /// The status of the charge, one of canceled, chargeable, consumed, failed, or pending.
        /// Only chargeable source objects can be used to create a charge.
        /// </summary>
        [JsonProperty("status")]
        ...
        /// <summary>
        /// The type of the source. The type is a payment method, one of card, three_d_secure,
        /// giropay, sepa_debit, ideal, klarna, sofort, or bancontact.
        /// </summary>
        [JsonProperty("type")]
        public string Type { get; set; }

        /// <summary>
        /// One of reusable, single-use. Whether this source should be reusable or not. Some source
        /// types may or may not be reusable by construction, while other may leave the option at
