namespace Stripe
{
    ...
    public class SourceReceiver : StripeEntity<SourceReceiver>
    {
        ...
        /// <summary>
        /// The total amount charged by you. The amount charged is expressed in the source's
        /// currency.
        /// </summary>
        ...
        /// <summary>
        /// The total amount received by the receiver source. AmountReceived = AmountReturned +
        /// AmountCharged is true at all times. The amount received is expressed in the source's
        /// currency.
        /// </summary>
