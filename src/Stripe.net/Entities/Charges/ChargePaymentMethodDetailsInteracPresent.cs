namespace Stripe
{
    ...
    public class ChargePaymentMethodDetailsInteracPresent : StripeEntity<ChargePaymentMethodDetailsInteracPresent>
    {
        ...
        /// characters, special characters and first/last name separator (`/`).
        /// </summary>
        ...
        /// <c>diners</c>, <c>discover</c>, <c>interac</c>, <c>jcb</c>, <c>mastercard</c>,
        /// <c>unionpay</c>, <c>visa</c>, or <c>unknown</c>.
        /// </summary>
        [JsonProperty("network")]
        public string Network { get; set; }

        /// <summary> How were card details read in this transaction.  Can be
        /// <c>contact_emv</c>, <c>contactless_emv</c>, <c>magnetic_stripe_fallback</c>,
        /// <c>magnetic_stripe_track2</c>, or <c>contactless_magstripe_mode</c>.
        /// </summary>
