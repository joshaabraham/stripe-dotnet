namespace Stripe
{
    ...
    public class ChargeOutcome : StripeEntity<ChargeOutcome>
    {
        ...
        /// blocked by Stripe after bank authorization, and may temporarily appear as “pending” on a
        ...
        /// <summary>
        /// An enumerated value indicating a more detailed explanation of the outcome's type. See
