namespace Stripe
{
    ...
    public class Subscription : StripeEntity<Subscription>, IHasId, IHasMetadata, IHasObject
    {
        ...
        /// <summary>
        /// If the subscription has been canceled with the <see cref="CancelAtPeriodEnd" /> flag set
        /// to true, <see cref="CancelAtPeriodEnd" /> on the subscription will be true.  You can use
        ...
        /// subscription was canceled with <see cref="CancelAtPeriodEnd" />, <see cref="CanceledAt"
        ...
        /// will be null for subscriptions where billing=charge_automatically.
        /// </summary>
        ...
        /// <summary>
        /// If specified, deferred upgrade changes that will be applied to the subscription once the
        /// <see cref="LatestInvoice" /> has been paid.
        /// </summary>
