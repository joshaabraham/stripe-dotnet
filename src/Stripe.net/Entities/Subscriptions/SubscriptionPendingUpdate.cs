namespace Stripe
{
    ...
    public class SubscriptionPendingUpdate : StripeEntity<SubscriptionPendingUpdate>
    {
        ...
        /// <summary>
        /// Indicates if a <see cref="Plan.TrialPeriodDays"/> should be applied to the subscription.
        /// Setting <see cref="TrialEnd"/> per subscription is preferred, and this defaults to
        /// false. Setting this flag to true together with <see cref="TrialEnd"/> is not allowed.
        /// </summary>
