namespace Stripe
{
    ...
    public class OrderReturn : StripeEntity<OrderReturn>, IHasId, IHasObject
    {
        ...
        /// <summary>
        /// <para>The order that this return includes items from.</para> <para>Expandable.</para>
        /// </summary>
        [JsonIgnore]
        ...
        /// <summary>
        /// <para>The ID of the refund issued for this return.</para> <para>Expandable.</para>
        /// </summary>
        [JsonIgnore]
