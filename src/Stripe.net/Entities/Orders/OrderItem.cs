namespace Stripe
{
    ...
    public class OrderItem : StripeEntity<OrderItem>, IHasObject
    {
        ...
        /// ¥1, Japanese Yen being a 0-decimal currency) representing the total amount for the line
        /// item.
        /// </summary>
        [JsonProperty("amount")]
        ...
        /// <summary>
        /// Description of the line item, meant to be displayable to the user (e.g., "Express
        /// shipping").
        /// </summary>
        ...
        /// <summary>
        /// A positive integer representing the number of instances of parent that are included in
        /// this order item. Applicable/present only if type is sku.
        /// </summary>
